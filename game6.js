...
//ArnalA
chassisBody.position.set(-325.3, -5, -101)
//chassisBody.position.set(100,5,-205)
...
wheelBodyA1 = new CANNON.Body({ mass: 70 })
...
cube1.position.set(-330.3, -7.8, -123);
scene.add(cube1);
...
if (!collided) {
  ...
  if (checkCollision(cube1,mesh)) {
   ...
   window.location.href = "./game7.html"; // Ya window.open("https://example.com");
  }
}
