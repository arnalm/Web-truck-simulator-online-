...
//ArnalA
chassisBody.position.set(3,4,3)
...
//___________
function checkCollision1(obj2, obj3) {
  obj2.updateMatrixWorld();
  obj3.updateMatrixWorld();
  
  const box2 = new THREE.Box3().setFromObject(obj2);
  const box3 = new THREE.Box3().setFromObject(obj3);
  
  return box2.intersectsBox(box3);
}
...
if (!collided) {
  ...
  if (checkCollision1(cube2, mesh)) {
    collided = true;
    console.log('Collision Detected!');
   window.location.href = "./game3.html"; // Ya window.open("https://example.com");
    alert('3')
  }
}
