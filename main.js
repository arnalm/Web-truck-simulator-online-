...
const camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.1, 23000);
...
//ArnalA
chassisBody.position.set(130,5, -80)
...
J2.quaternion.setFromEuler(0, 0, 0);
J2.addShape(jamin2)
world.addBody(J2)
...
const J7 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(-20, -5, 20)
})
...
const J10 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(23, -5.2, 30)
})
...
const J11 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(40, -4.8, 50)
})
...
const J12 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(40, -7, -10)
})
...
const J17 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(20,-4.8, -10)
})
...
const J21 = new CANNON.Body({
  mass: 0,
  position: new CANNON.Vec3(110,2, -70)
})
...
loader.load("./tree/grass /Grass.glb", function(gltf) {
  const grass = gltf.scene;
  grass.position.set(-128, 1, -177);
  grass.scale.set(3, 3.7, 3)
  scene.add(grass);
});

loader.load("./tree/grass /Grass.glb", function(gltf) {
  const grass = gltf.scene;
  grass.position.set(-130, 1, -175);
  grass.scale.set(3, 2.7, 3)
  scene.add(grass);
});

loader.load("./tree/grass /Grass.glb", function(gltf) {
  const grass = gltf.scene;
  grass.position.set(-112, 1, -180);
  grass.scale.set(3, 2.7, 3)
  scene.add(grass);
});
...
loader.load("./tree/grass /Grass.glb", function(gltf) {
  const grass = gltf.scene;
  grass.position.set(-120, 3.3, -120);
  grass.scale.set(3, 2.7, 3)
  scene.add(grass);
});
...
loader.load("./barnHouse/Silo House.glb", function(gltf) {
  const houseM1 = gltf.scene;
  houseM1.position.set(-40, 1.5, -35);
...
if (!collided) {
  ...
  if (checkCollision(cube1,mesh)) {
    ...
    window.location.href = "./game2.html"; // Ya window.open("https://example.com");
  }
}
