...
class JoyStick{
	constructor(options){
		...
		circle.style.cssText = "position: fixed; bottom:35px; width:80px; height:80px; background:rgba(126, 126, 126, 0.5); border:#444 solid medium; border-radius:50%; left:20%; top:61%; transform:translateX(-50%);";
